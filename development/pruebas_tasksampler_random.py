...
from garage.torch.policies import GaussianMLPPolicy, CategoricalCNNPolicy, RandomPolicy
...
def maml_ppo_random_maze_dir(ctxt, seed, epochs, episodes_per_task,
                           meta_batch_size):
